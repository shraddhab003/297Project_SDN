...
if __name__ == '__main__':
	...
	n1 = input("Enter the number of nodes in Network1: ")
	m2 = input("Enter the number of edges to be added from new node to the existing one: ")
    G1 = nx.generators.barabasi_albert_graph(n1,m1)
	
	n2 = input("Enter the number of nodes in Network2: ")
    m2 = input("Enter the number of edges to be added from new node to the existing one: ")
    G2 = nx.generators.barabasi_albert_graph(n2,m2)	
	
	print ('The nodes in network 1 graph:', G1.nodes())
	print ('The nodes in network 2 graph:', G2.nodes())

    # Calculating the shortest path between the nodes
	start = input("Enter the source node:")
	dest = input("Enter the destiation node:")
